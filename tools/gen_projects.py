...
META = {
    '1. NMZ Namangan Metallurgiya za': dict(
        ...
        logo='assets/img/logos/NMZ-logo 26.png', image=1,
        ...
        banner='assets/img/projects/other/other (1).jpeg',
        gallery=[
            'assets/img/projects/other/other (2).jpeg',
            'assets/img/projects/other/other (3).jpeg',
            'assets/img/projects/other/other (4).jpeg',
            'assets/img/projects/other/other (5).jpeg',
        ],
    ),
    '2. TMZ Tojikiston metallurgiya ': dict(
        slug='tmz', cat='metallurgy', catLabel='Металлургия',
        logo='assets/img/logos/TMZ.png', image=4,
        ...
        relatedHeading='металлургические активы',
        banner='assets/img/projects/tmz/banner.JPG',
        gallery=[
            'assets/img/projects/tmz/1.JPG',
            'assets/img/projects/tmz/2.JPG',
            'assets/img/projects/tmz/3.JPG',
            'assets/img/projects/tmz/4.jpg',
        ],
    ),
    '3. JMZ Jizzax metallurgiya zavo': dict(
        slug='jmz', cat='metallurgy', catLabel='Металлургия',
        logo='assets/img/logos/JMZ-logo (horizontal dark).png', image=2,
        ...
        relatedHeading='металлургические активы',
        banner='assets/img/projects/jmz/banner.JPG',
        gallery=[
            'assets/img/projects/jmz/1.JPG',
            'assets/img/projects/jmz/2.JPG',
            'assets/img/projects/jmz/3.JPG',
            'assets/img/projects/jmz/4.JPG',
            'assets/img/projects/jmz/5.JPG',
            'assets/img/projects/jmz/6.JPG',
        ],
    ),
    '4. BA Chirchiq Metall': dict(
        slug='ba-chirchiq-metall', cat='metallurgy', catLabel='Металлургия',
        logo='assets/img/logos/BA Chiqchiq metall logo 26.png', image=5,
        ...
        relatedHeading='металлургические активы',
        banner='assets/img/projects/chirchik-metall/banner.jpg',
        gallery=[
            'assets/img/projects/chirchik-metall/1.jpg',
            'assets/img/projects/chirchik-metall/2.jpg',
            'assets/img/projects/chirchik-metall/3.jpg',
        ],
    ),
    '5. Emirate Steel': dict(
        slug='emirate-steel', cat='metallurgy', catLabel='Металлургия',
        logo='assets/img/logos/Emirate steel 26-3.png', image=3,
        ...
        relatedHeading='металлургические активы',
        banner='assets/img/projects/other/other (6).jpeg',
        gallery=[
            'assets/img/projects/other/other (7).jpeg',
            'assets/img/projects/other/other (8).jpeg',
            'assets/img/projects/other/other (9).jpeg',
            'assets/img/projects/other/other (10).jpeg',
        ],
    ),
    '6. Fu-xin': dict(
        slug='fuxin', cat='production', catLabel='Производство',
        logo='assets/img/logos/Фухин.png', image=6,
        ...
        banner='assets/img/projects/fuxin/banner.png',
        gallery=[
            'assets/img/projects/fuxin/1.jpg',
            'assets/img/projects/fuxin/2.jpg',
            'assets/img/projects/fuxin/3.jpg',
            'assets/img/projects/fuxin/4.jpg',
            'assets/img/projects/fuxin/5.jpg',
            'assets/img/projects/fuxin/6.jpg',
        ],
    ),
    '7. China House ': dict(
        slug='china-house', cat='construction', catLabel='Строительство',
        logo='assets/img/logos/China house-logo 26.png', image=8,
        shortLoc='Ташкент, Бектемирский р-н',
        ...
        banner='assets/img/projects/china-house/banner.jpg',
        gallery=[
            'assets/img/projects/china-house/1.png',
            'assets/img/projects/china-house/2.png',
            'assets/img/projects/china-house/3.png',
            'assets/img/projects/china-house/5.jpg',
            'assets/img/projects/china-house/6.png',
            'assets/img/projects/china-house/7.png',
        ],
    ),
    '8. Toshkent Plast Polimer': dict(
        slug='tpp', cat='production', catLabel='Производство',
        logo='assets/img/logos/TPP-logo 26.png', image=10,
        ...
        relatedHeading='производственные активы',
        banner='assets/img/projects/plast-polimer/banner.JPG',
        gallery=[
            'assets/img/projects/plast-polimer/1.JPG',
            'assets/img/projects/plast-polimer/2.JPG',
            'assets/img/projects/plast-polimer/3.JPG',
            'assets/img/projects/plast-polimer/4.JPG',
            'assets/img/projects/plast-polimer/5.JPG',
            'assets/img/projects/plast-polimer/6.JPG',
        ],
    ),
    '9. BA Texnopark': dict(
        slug='ba-texnopark', cat='production', catLabel='Производство',
        logo='assets/img/logos/BA Texnopark-removebg-preview 26.png', image=11,
        ...
        relatedHeading='производственные активы',
        banner='assets/img/projects/other/other (11).jpeg',
        gallery=[
            'assets/img/projects/other/other (12).jpeg',
            'assets/img/projects/other/other (13).jpeg',
            'assets/img/projects/other/other (14).jpeg',
            'assets/img/projects/other/other (15).jpeg',
        ],
    ),
    '10. Awiner AGRО': dict(
        slug='awiner-agro', cat='agro', catLabel='Агрохимия',
        logo='assets/img/logos/AWINER AGRO logo 26.png', image=12,
        ...
        banner='assets/img/projects/agro/banner.jpg',
        gallery=[
            'assets/img/projects/agro/1.jpg',
            'assets/img/projects/agro/2.jpg',
            'assets/img/projects/agro/3.jpg',
        ],
    ),
    '11. Sirdarya Metal Construction': dict(
        slug='sirdarya-metal-construction', cat='production', catLabel='Производство',
        logo='assets/img/logos/Sirdarya Metal Construction 26.png', image=7,
        shortLoc='Сырдарьинская обл., Хакикат',
        ...
        relatedHeading='производственные активы',
        banner='assets/img/projects/other/other (16).jpeg',
        gallery=[
            'assets/img/projects/other/other (17).jpeg',
            'assets/img/projects/other/other (18).jpeg',
            'assets/img/projects/other/other (19).jpeg',
            'assets/img/projects/other/other (20).jpeg',
        ],
    ),
    '12. Shengli Steel': dict(
        slug='shengli-steel', cat='metallurgy', catLabel='Металлургия',
        logo='assets/img/logos/Shengli Steel 26.png', image=9,
        ...
        relatedHeading='металлургические активы',
        banner='assets/img/projects/other/other (21).jpeg',
        gallery=[
            'assets/img/projects/other/other (22).jpeg',
            'assets/img/projects/other/other (23).jpeg',
            'assets/img/projects/other/other (24).jpeg',
            'assets/img/projects/other/other (25).jpeg',
        ],
    ),
    '13. Tai Chang Group': dict(
        slug='tai-chang-group', cat='metallurgy', catLabel='Металлургия',
        logo='assets/img/logos/Ti Chang Group 26-3.png', image=11,
        shortLoc='Ташкентская обл., Ахангаранский р-н',
        ...
        relatedHeading='металлургические активы',
        banner='assets/img/projects/other/other (26).jpeg',
        gallery=[
            'assets/img/projects/other/other (27).jpeg',
            'assets/img/projects/other/other (28).jpeg',
        ],
    ),
}
